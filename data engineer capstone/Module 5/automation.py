...
import psycopg2
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='7B1iNa0byUWLFNts35EMr1Ku',host='172.21.108.60',database='sales')
cursor = connection.cursor()

# Connect to DB2 or PostgreSql
dsn_hostname = '172.21.163.211'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='Q0Kfl23kpckjwGDJfiOkGI9h'      # e.g. "7dBZ3wWt9XN6$o0J"
...
def get_last_rowid():
    pgcursor.execute("SELECT MAX(rowid) FROM sales_data")
